                    ...
                    <div class="column">
                        ...
                        <div class="columns">
                            ...
                            <div class="column is-8">
                                <input v-model="nodeIp" v-on:keyup.13="setHostNode" class="input" type="text"
        ...
        <nav v-if="code === 'NODE_NOT_SET'" class="level">
            <div class="level-item has-text-centered">
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="password" v-on:keyup.13="setHostNode" class="input" type="password"
        ...
        <nav v-if="code === 'NODE_NOT_SET'" class="level">
            <div class="level-item has-text-centered">
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="iriFileLocation" v-on:keyup.13="setHostNode" class="input" type="text"
        ...
        <nav v-if="code === 'NODE_NOT_SET'" class="level">
            <div class="level-item has-text-centered">
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="restartNodeCommand" v-on:keyup.13="setHostNode" class="input" type="text"
...
<script>
  ...
  export default {
    ...
    methods: {
      setHostNode() {
        if (this.code === 'NODE_NOT_SET' ? this.password && this.nodeIp : this.nodeIp) {
